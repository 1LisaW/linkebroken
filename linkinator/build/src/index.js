...
class LinkChecker extends events_1.EventEmitter {
     ...
     */
    async check(options) {
        options.linksAttributes = Object.assign(Object.assign({}, links_1.getBaseLinkAttributes()), options.linksAttributes);
    ...
    async crawl(opts) {
        ...
        const result = {
            url: responseUrl,
            originalUri: responseUrl !== opts.url.href ? opts.url.href : '',
            status,
            state,
            parent: opts.parent,
        };
        ...
        if (opts.crawl && shouldRecurse) {
            ...
            const urlResults = links_1.getLinks(data, result.url, opts.checkOptions.linksAttributes || {});
